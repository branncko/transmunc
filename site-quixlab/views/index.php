...
<head>
    ...
    <title>Sistema de Transparência Municipal</title>
    <!-- Favicon icon -->
                ...
                <div class="header-right">
                    <ul class="clearfix">
                        <li class="icons dropdown"><a href="javascript:void(0)" data-toggle="dropdown">
                                ...
                                <span class="badge badge-pill gradient-1">5</span>
                            </a>
                            <div class="drop-down animated fadeIn dropdown-menu">
                                <div class="dropdown-content-heading d-flex justify-content-between">
                                    <span class="">5 Mensagens novas</span>  
                                    <a href="javascript:void()" class="d-inline-block">
                                        <span class="badge badge-pill gradient-1">6</span>
                                    </a>
                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body border-top pt-4">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <ul>
                                            <li>5% em Retorno Negativo</li>
                                            <li>95% em Retorno Positivo </li>
                                        </ul>
                                        <div>
